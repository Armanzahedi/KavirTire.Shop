...
using KavirTire.Shop.Application.Common.Helpers;
...
using KavirTire.Shop.Infrastructure.PaymentService.IranKish.Models;
using Newtonsoft.Json;
using RestSharp;

namespace KavirTire.Shop.Infrastructure.PaymentService.IranKish;

[BankType(Bank.IranKish)]
public class IranKishPaymentService : Application.Payments.Services.PaymentService.PaymentService 
{
    private readonly Ipg _ipg;

    public IranKishPaymentService(Ipg ipg) : base(ipg)
    {
        _ipg = ipg;
    }
    ...
    public override Task<string> GetGatewayUrl(Invoice invoice,  Payment payment, BankAccount bankAccount,BankAccount? postBankAccount,string? customerMobileNumber)
    {
